...
using static CrytonCore.Helpers.MD5Helper;
    ...
    public class MD5
    {
        ...
        public string Value
        {
            ...
            set
            {
                ...
                result = CalculateMD5Value();

                /// raise the event to notify the change
                if (this.OnValueChanged != null)
                    OnValueChanged(this, new MD5ChangedEventArgs(value, result.ToString()));
        ...
        {
            a = b + MDHelper.RotateLeft((a + ((b & c) | (~(b) & d)) + X[k] + T[i - 1]), s);
        }
        ...
        {
            a = b + MDHelper.RotateLeft((a + ((b & d) | (c & ~d)) + X[k] + T[i - 1]), s);
        }
        ...
        {
            a = b + MDHelper.RotateLeft((a + (b ^ c ^ d) + X[k] + T[i - 1]), s);
        }
        ...
        {
            a = b + MDHelper.RotateLeft((a + (c ^ (b | ~d)) + X[k] + T[i - 1]), s);
        }
